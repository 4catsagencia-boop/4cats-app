  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-3 pointer-events-none">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="pointer-events-auto btn-squish group relative flex items-center justify-center w-16 h-16 bg-[#7C5CBF]/90 dark:bg-[#7C5CBF]/80 backdrop-blur-md text-white rounded-full shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 border border-white/20 dark:border-white/10"
        style={{ 
          boxShadow: "0 0 30px -5px rgba(124, 92, 191, 0.5)",
        }}
      >
        {/* Shine effect */}
        <div className="absolute inset-0 bg-gradient-to-tr from-white/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-full" />
        
        {/* Icon */}
        <svg className="w-8 h-8 relative z-10 transition-transform group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
        ...
        <span className="absolute flex h-full w-full">
          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#7C5CBF] opacity-30"></span>
        </span>
      </a>
