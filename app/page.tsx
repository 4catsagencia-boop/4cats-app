        ...
        <div className="relative max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {tr.stackItems.map((item, idx) => {
              const iconColors = ["#F8F8F8", "#38BDF8", "#10B981", "#3B82F6", "#67E8F9", "#F8F8F8"]
              const iconBg = ["#18181B", "#0C4A6E", "#064E3B", "#1E3A8A", "#0E7490", "#18181B"]
              return (
                ...
                <div className="bento-cell glass-card rounded-3xl p-6 cursor-default h-full">
                  <div
                    ...
                    style={{ backgroundColor: iconBg[idx], color: iconColors[idx] }}
                  >
