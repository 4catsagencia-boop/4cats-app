            ...
            <button
              ...
              className={`text-xs font-semibold px-3 py-1.5 rounded-lg transition-all ${
                filtro === f.key
                  ...
                  : "bg-[#F4F4F5] dark:bg-[#27272A] text-[#52525B] dark:text-[#A1A1AA] hover:bg-[#E4E4E7] dark:hover:bg-[#3F3F46]"
              }`}
            >
              {f.label}
            </button>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#E4E4E7] dark:border-[#2A2A35]">
                ...
                <th className="text-center text-xs font-semibold text-[#A1A1AA] uppercase tracking-wider px-5 py-3">Acción</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#F4F4F5] dark:divide-[#2A2A35]">
              {filtradas.length === 0 && (
                <tr>
                  <td colSpan={6} className="text-center text-[#A1A1AA] py-8">Sin resultados</td>
                </tr>
              )}
              {filtradas.map((c) => (
                <tr key={c.id} className="hover:bg-[#FAFAFA] dark:hover:bg-[#1C1C1E] transition-colors">
                  ...
                  <td className="px-5 py-3 text-[#52525B] dark:text-[#A1A1AA] hidden md:table-cell">{c.plan_nombre}</td>
                  ...
                  <td className="px-5 py-3 text-center">
                    <select
                      ...
                      className="text-xs border border-[#E4E4E7] dark:border-[#2A2A35] bg-white dark:bg-[#27272A] text-[#18181B] dark:text-white rounded-lg px-2 py-1 disabled:opacity-50 cursor-pointer"
                    >
